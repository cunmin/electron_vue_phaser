export default class Preloader extends Phaser.Scene
{
    ...
    preload ()
    {
        ...
        this.load.setPath('src/renderer/assets/germs/');
        // this.load.setPath('../../assets/germs/');

        this.load.atlas('cards', '../cards.png', '../cards.json');

        this.load.atlas('assets', 'germs.png', 'germs.json');
        this.load.glsl('goo', 'goo.glsl.js');
        // this.load.glsl('goo', 'testglsl1.glsl.js');

        //  Audio ...
        // this.load.setPath('assets/games/germs/sounds/');
        this.load.setPath('src/renderer/assets/germs/sounds/');
        // this.load.setPath('../../assets/germs/sounds/');
